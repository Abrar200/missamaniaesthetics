"""
Django settings for surgeon project.
...
SECRET_KEY = 'django-insecure--70qbl%(1a^w%)$bw-((*svori)4*()dz-p(#iw20g)xl9pxfj'
...
WSGI_APPLICATION = 'surgeon.wsgi.application'
